    ...
    return (
        ...
        <div className="philosophy_container">
            <div className="philosophy_title">
                    <p>Your expectations met. Your targets reached, be a part of the TWI</p>
                <h2><span className='transparent-outline-green'>PHILOSOPHY</span></h2>
            </div>
            <div className="philosophy_content">
                ...
                <div className="philosophy_images">
                    ...
                    <h3><span className='transparent-outline-green'>INTENT</span></h3>
                    <p>
                ...
                <img src="./images/intent-data-driven-pie.svg" alt="intent data" className="philosophy_image" />
                    <h3><span className='transparent-outline-green'>DATA DRIVEN</span></h3>
                    <p>
                ...
                <img src="./images/intent-use-of-science.svg" alt="intent science" className="philosophy_image" />
                    <h3><span className='transparent-outline-green'>USE OF SCIENCE</span></h3>
                    <p>
